...
videos = {
    ...
    'Basketbol Sahası': {'path': 'video_01.mp4', 'capacity': 10, 'start': 12, 'end': 21, "icon": "Files/basketball.png"},
    'Tenis kortu': {'path': 'video_01.mp4', 'capacity': 4, "start": 12, "end": 23, "icon": "Files/tennis_racket.png"},
}
...
class Apsiyon(QWidget):
    ...
    def initUI(self, time_index):
        ...
        for place, info in videos.items():
            ...
            button.setFixedSize(100, 50)  # Set the button size
    ...
    def show_donut_chart(self, place, time_index):
        ...
        # Draw background arc (light gray for the remaining part)
        ...
        # Add text
        font = ImageFont.truetype("arial.ttf", 12)  # Use truetype font for better clarity
    ...
    def show_graph(self, place, time_index):
        ...
        self.figure = Figure(figsize=(40,20), dpi=100)
