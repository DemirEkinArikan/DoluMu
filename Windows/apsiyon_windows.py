...
videos = {
    ...
    'Basketbol Sahası': {'path': 'video_01.mp4', 'capacity': 10, 'start':12,'end': 23,"icon":"basketball.png"},
    'Tenis kortu': {'path': 'video_01.mp4', 'capacity': 4,"start":6 , "end":18,"icon":"tennis_racket.png" },
}
